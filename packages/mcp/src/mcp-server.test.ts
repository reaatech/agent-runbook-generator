...
describe('RunbookMCPServer', () => {
  ...
  describe('tool registration', () => {
    it('registers analysis tools', async () => {
      const { registerAnalyzeTools } = await import('@reaatech/agent-runbook-mcp');
    ...
    it('registers generation tools', async () => {
      const { registerGenerateTools } = await import('@reaatech/agent-runbook-mcp');
    ...
    it('registers validation tools', async () => {
      const { registerValidateTools } = await import('@reaatech/agent-runbook-mcp');
