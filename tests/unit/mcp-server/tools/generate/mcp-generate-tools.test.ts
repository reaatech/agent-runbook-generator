...
import { execute as executeServiceMap } from '../../../../../src/mcp-server/tools/generate/service_map.js';
import { execute as executeHealthChecks } from '../../../../../src/mcp-server/tools/generate/health_checks.js';
...
vi.mock('../../../../../src/service-map/dependency-analyzer.js', () => ({
...
vi.mock('../../../../../src/service-map/graph-generator.js', () => ({
  exportGraph: vi.fn().mockReturnValue('graph-export-content'),
}));

vi.mock('../../../../../src/health-checks/check-generator.js', () => ({
