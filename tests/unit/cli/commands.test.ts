...
vi.mock('../../../src/analyzer/repository-scanner.js', () => ({
...
vi.mock('../../../src/analyzer/dependency-mapper.js', () => ({
...
vi.mock('../../../src/runbook/runbook-builder.js', () => ({
...
vi.mock('../../../src/runbook/formatter.js', () => ({
...
vi.mock('../../../src/mcp-server/mcp-server.js', () => ({
...
describe('analyzeCommand', () => {
  it('registers the analyze command on a Commander program', async () => {
    const { analyzeCommand } = await import('../../../src/cli/commands/analyze.command.js');
...
describe('generateCommand', () => {
  it('registers the generate command on a Commander program', async () => {
    const { generateCommand } = await import('../../../src/cli/commands/generate.command.js');
    const program = new Command();
...
describe('exportCommand', () => {
  it('registers the export command on a Commander program', async () => {
    const { exportCommand } = await import('../../../src/cli/commands/export.command.js');
    const program = new Command();
...
describe('serveCommand', () => {
  it('registers the serve command on a Commander program', async () => {
    const { serveCommand } = await import('../../../src/cli/commands/serve.command.js');
    const program = new Command();
