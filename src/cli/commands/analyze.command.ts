...
import { analyzeDependencies } from '../../analyzer/dependency-mapper.js';
import { info, initLogger } from '../../observability/logger.js';
import { startAnalysisSpan, endSpanSuccess, endSpanError } from '../../observability/tracing.js';
import { parseIntOptional } from '../../utils/validation.js';
